...
export const BLOCK_LIBRARY = [
  ...
  { kind: 'webinar',   label: L('Webinar', 'เว็บบินาร์'),                  group: 'layout' },
...
export const DEFAULT_PROPS = {
  header: {
    img: '/samples/sample-13.webp', alt: 'Email banner', href: '',
  ...
  gallery: {
    ...
    gap: 6,
    items: [
      { id: 'g1', src: '/samples/sample-03.webp', colSpan: 3, rowSpan: 2 },
      { id: 'g2', src: '/samples/sample-05.webp', colSpan: 1, rowSpan: 1 },
      { id: 'g3', src: '/samples/sample-17.webp', colSpan: 1, rowSpan: 1 },
      { id: 'g4', src: '/samples/sample-15.webp', colSpan: 1, rowSpan: 1 },
    ],
  },
  twocol: {
    a_img: '/samples/sample-02.webp',
  ...
  threecol: {
    a_img: '/samples/sample-04.webp', a_title: 'Pipeline', a_copy: '28 approved medicines in 2025.', a_cta: 'Learn more →', a_href: 'https://roche.com',
    b_img: '/samples/sample-10.webp', b_title: 'People', b_copy: '100k+ Roche colleagues worldwide.', b_cta: 'Learn more →', b_href: 'https://roche.com',
    c_img: '/samples/sample-11.webp', c_title: 'Patients', c_copy: 'Reaching more communities than ever.', c_cta: 'Learn more →', c_href: 'https://roche.com',
    img_h: 110,
  },
  storylist: {
    count: 3,
  ...
  webinar: {
    bannerImg: '/samples/sample-19.webp',
    bannerH: 280,
    bodyBg: '#FFFFFF',
    ...
    speakerImg: '/samples/sample-21.webp',
    speakerSize: 160,
    ...
    disclaimer: 'Disclaimer: This is a medical-scientific educational webinar for healthcare professionals',
    ctaLabel: 'Register',
    ctaHref: 'https://roche.com',
  },
  quote: {
  ...
  podcast: {
    ...
    artwork: '/samples/sample-20.webp',
...
export const FIELDS = {
  ...
  webinar: [
    ...
    ['speakerSize', L('Speaker photo size', 'ขนาดรูปวิทยากร'), 'slider', { min: 100, max: 280, step: 10, suffix: 'px' }],
    ['speakerName', L('Speaker name', 'ชื่อวิทยากร'), 'text'],
    ['speakerInfo', L('Speaker credentials', 'ตำแหน่งวิทยากร'), 'textarea'],
    ['date', L('Date', 'วันที่'), 'text'],
    ['time', L('Time', 'เวลา'), 'text'],
    ['disclaimer', L('Disclaimer', 'ข้อความแจ้ง'), 'textarea'],
    ['ctaLabel', L('Button label', 'ป้ายปุ่ม'), 'text'],
    ['ctaHref', L('Button URL', 'ลิงก์ปุ่ม'), 'url'],
  ],
  quote: [
